...
Route::group( [ 'prefix' => '/admin', 'middleware' => [ 'auth', 'superadmin' ] ], function () {
	...
	Route::prefix( 'requests' )->group( function () {
		Route::get( '/', 'admin\Requestsontroller@index' )->name( 'admin.requests.index' );
		Route::get( '/{request}/accept', 'admin\Requestsontroller@accept' )->name( 'admin.requests.accept' );
	} );
} );
Route::group( [ 'prefix' => '/manger', 'middleware' => [ 'auth' ] ], function () {
	...
	Route::prefix( 'requests' )->group( function () {
		...
		Route::get( '/', 'manger\RequestsController@index' )->name( 'requests.index' );

		Route::get( '/create', 'manger\RequestsController@create' )->name( 'requests.create' );

		Route::post( '/store', 'manger\RequestsController@store' )->name( 'requests.store' );

		Route::get( '/{request}/show', 'manger\RequestsController@show' )->name( 'requests.show' );

		Route::delete( '/{request}/destroy', 'manger\RequestsController@destroy' )->name( 'requests.destroy' );

	} );
	Route::prefix( 'store' )->group( function () {

		Route::get( '/', 'manger\RequestsController@storeProduct' )->name( 'store.product.index' );
	} );
