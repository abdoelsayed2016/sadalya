...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-2">
        ...
        <li class="active"><strong style="font-family: zona_probold; font-size: 28px ">Products</strong></li>
    ...
    <table class="table table-striped table-bordered table-hover dt-responsive nowrap" id="vacations">
        ...
        @foreach($products as $index=>$product)
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('products.show', $product->id) }}" class="btn btn-warning"><span class="fa fa-eye"></span></a>
                    <a href="{{ route('products.edit', $product->id) }}" class="btn btn-primary"><span class="fa fa-edit"></span></a>

                    <a type='button' class='btn btn-danger' data-toggle='modal' data-target="#confirmation{{$product->id}}"> <span class="fa fa-trash"></span> </a>
                    <?php
                    $route=route('products.destroy', $product->id);
                    $id= $product->id;
                    $message="Do You Want To Delete This Products ?";
                    ?>
